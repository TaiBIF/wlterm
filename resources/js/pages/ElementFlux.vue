        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { type: 'text', title: '氟 (mg/L)', width: '90', name: 'Fl'},
                    { type: 'text', title: '氨 (mg/L)', width: '90', name: 'NH4'},
                    { type: 'text', title: '鈉 (mg/L)', width: '90', name: 'Na'},
                    { type: 'text', title: '鎂 (mg/L)', width: '90', name: 'Mg'},
                    { type: 'text', title: '鉀 (mg/L)', width: '90', name: 'K'},
                    { type: 'text', title: '鈣 (mg/L)', width: '90', name: 'Ca'},
                    { type: 'text', title: '鍶 (mg/L)', width: '90', name: 'Sr'},
                    { type: 'text', title: '鋇 (mg/L)', width: '90', name: 'Ba'},
                    { type: 'text', title: '矽 (mg/L)', width: '90', name: 'Si'},
                    { type: 'text', title: '溶解有機碳 (mg/L)', width: '90', name: 'DOC'},
                ],
                total: 0,
            }
        },
