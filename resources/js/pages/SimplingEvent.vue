        ...
        data() {
            return {
                ...
                columns: [
                    ...
                    { type: 'text', title: '原紀錄學名', width: '100', name: 'id', searchable: true },
                    { type: 'text', title: '接受學名', width: '180', name: 'scientific_name', searchable: true },
                    { type: 'text', title: '中文名', width: '120', name: 'chinese' },
                    { type: 'text', title: '個體數', width: '60', name: 'individual_count' },
                    { type: 'text', title: '覆蓋率', width: '60', name: 'cover_rate', searchable: true },
                    { type: 'text', title: '體長', width: '60', name: 'body_length', searchable: true },
                    { type: 'text', title: '體長單位', width: '60', name: 'body_length_unit', searchable: true },
